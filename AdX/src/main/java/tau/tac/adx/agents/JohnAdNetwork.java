 ...
 * 
 */
public class JohnAdNetwork extends Agent {

	private final Logger log = Logger
			.getLogger(JohnAdNetwork.class.getName());
	...
	private void handleInitialCampaignMessage(
		...
		//System.out.println("\t campaign full info put in comment");
		 ...
		 */
		System.out.println("\n\nDay " + day + ": Allocated campaign - " + campaignData+"\n\n");
	...
	private void handleICampaignOpportunityMessage(
		...
		System.out.println("____________START OPPORTUNITY MESSAGE DAY "+day+"_____________\n");
	...
	private void handleAdNetworkDailyNotification(
		...
		System.out.println("\n\n____________START DAILY NOTIFICATION DAY "+day+"______________\n");
	...
	protected void sendBidAndAds() {
		...
		System.out.println("\n\n______________SEND BIDS AND ADS DAY "+day+"___________________\n");
